...
treasure = input('You\'re at a crossroad. Where do you want to go? Type \"left\" or \"right\"')
treasure = treasure.lower()
if treasure == "left":
    swim = input('You\'ve come to a lake. There is an island in the middle of the lake. Type \"wait\" to wait for a '
